...
<header
	class="flex h-16 shrink-0 items-center justify-between border-b border-slate-200 bg-white px-4 shadow-sm lg:px-6"
>
	<div class="flex items-center">
		<button
			type="button"
			class="-ml-2 rounded-md p-2 text-slate-500 hover:bg-slate-100 focus:ring-2 focus:ring-blue-500 focus:outline-none focus:ring-inset lg:hidden"
